...
<form action="" id="expense-form">
    ...
    <div class="form-group">
        ...
        <option value=""></option>
        <?php
            $qry = $conn->query("SELECT * FROM `categories` where `balance` > 0 and userid = '$userid' order by category asc");
    ...
    <?php else: ?>
        <div class="form-group">
            ...
            <?php
            $qry = $conn->query("SELECT * FROM `categories` where id = '{$category_id}' and userid = '$userid'");
